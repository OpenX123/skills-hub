export default function Icon4() {
  return (
    <svg className="hidden h-4 w-4 max-lg:block max-lg:overflow-hidden max-lg:align-middle" height="16" viewBox="0 0 16 16" width="16" data-slot="geist-icon" fill="currentColor">
